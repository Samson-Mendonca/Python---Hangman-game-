...
word_list=["RUSSIA", "ARGENTINA", "MEXICO", "COLOMBIA" ,"KAZAKHSTAN", "GERMANY", "TURKEY", "HUNGARY" ,"FINLAND","INDIA",
            "CHINA", "SWEDEN", "MONGOLIA" ,"MORORCCO", "NORWAY", "CHILE", "IRELAND", "ICELAND", "ESTONIA", "CROATIA", "SPAIN",
            "NIGERIA" ,"JAPAN", "UKRAINE" ,"ALGERIA"]
...
def guess(letter):
    ...
    if numberOfGuesses<11:
        ...
        if the_word_withSpaces.count(letter)>0:
            ...
            if numberOfGuesses == 11:
                messagebox.showwarning("Hangman", "Try Again!")
